...
via `get_allocator`. That mechanism solves allocating the *initial*
...
C++26 specification. The window for fixing this architectural defect is now.
...
forward the allocator silently breaks the chain. The allocator becomes viral -
